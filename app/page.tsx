  ...
  useEffect(() => {
    const checkAuthAndLoadData = async () => {
      try {
        ...
        let coursesData = await courseService.getAll();

        // 🔽 Sort them in specific order
        const desiredOrder = ["html", "css", "javascript"];
        coursesData.sort(
          (a: any, b: any) =>
            desiredOrder.indexOf(a.id.toLowerCase()) -
            desiredOrder.indexOf(b.id.toLowerCase())
        );
          ...
          <div className="text-center max-w-2xl mx-auto px-4">
            <div className="animate-fade-in-up">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Premium courses in HTML, CSS, and JavaScript
              </p>
              <div className="bg-gradient-to-r from-gray-900/80 to-gray-800/40 rounded-2xl p-8 border border-gray-700/50 backdrop-blur-sm mb-8">
                <h2 className="text-2xl font-bold text-[#0fd8d7] mb-4">
                  Course Price: 400 EGP
                </h2>
                <p className="text-gray-300 mb-6">
                  Get access to all courses with lifetime updates and support
                </p>
                <div className="space-y-4">
                  <p className="text-sm text-gray-400">To purchase:</p>
                  <div className="bg-gray-800/50 rounded-lg p-4">
                    <p className="text-white mb-2">
                      1. Send 400 EGP via WhatsApp
                    </p>
                    <p className="text-white mb-2">
                      2. Receive your unique access code
                    </p>
                    <p className="text-white">
                      3. Enter the code below to start learning
                    </p>
                  </div>
                  <a
      ...
      <div className="relative z-10">
        ...
        <header className="border-b border-gray-800/50 backdrop-blur-sm bg-black/20">
          <div className="container mx-auto px-4 py-6 flex justify-between items-center">
            <h1 className="text-2xl font-bold text-[#0fd8d7] animate-fade-in-up">
              Frontend Academy
            </h1>
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          <div className="animate-fade-in-up animation-delay-200">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400">
              Learn HTML, CSS, and JavaScript through structured courses
              designed for beginners. Build real projects and track your
              progress as you become a frontend developer.
            </p>
        ...
        <section className="container mx-auto px-4 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-4">
            {courses.map((course, index) => (
              <div
                key={course.id}
                className="group relative flex flex-col bg-gradient-to-br from-gray-900/80 to-gray-800/60 rounded-3xl p-8 border border-gray-700/40 backdrop-blur-md shadow-md hover:shadow-xl hover:shadow-[#0fd8d7]/20 transition-all duration-500 transform hover:scale-[1.03] animate-fade-in-up min-h-[300px]"
              ...
              >
                ...
                {/* Title */}
                <h3 className="text-2xl font-bold mb-3 text-[#0fd8d7] group-hover:text-[#0bc5c4] transition-colors duration-300">
                  {course.title}
                </h3>

                {/* Description */}
                <p className="text-sm text-gray-300 mb-6 leading-relaxed group-hover:text-white transition-colors duration-300 line-clamp-4">
                  {course.description}
                </p>

                {/* Sessions */}
                <div className="mb-8">
                  <span className="text-xs font-medium text-gray-400 bg-gray-800/50 px-3 py-2 rounded-full tracking-wide">
                ...
                <Link
                  ...
                  className="mt-auto inline-block w-full text-center bg-gradient-to-r from-[#0fd8d7] to-[#0bc5c4] text-black font-semibold py-3 px-6 rounded-xl transition-all duration-300 hover:from-[#0bc5c4] hover:to-[#0fd8d7] hover:scale-105 hover:shadow-lg hover:shadow-[#0fd8d7]/30"
                >
                  Start Learning
                </Link>
              </div>
            ...
            {/* 🔧 Projects Card */}
            <div
              className="group relative bg-gradient-to-br from-purple-900/80 to-purple-800/60 rounded-3xl p-8 border border-purple-700/40 backdrop-blur-md shadow-md hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-500 transform hover:scale-[1.03] animate-fade-in-up min-h-[300px]"
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-2xl font-bold mb-3 text-purple-400 group-hover:text-purple-300 transition-colors duration-300">
                Projects
              </h3>

              {/* Description */}
              <p className="text-sm text-gray-300 mb-6 leading-relaxed group-hover:text-white transition-colors duration-300">
                Apply your skills with hands-on projects. Build real websites
                and applications.
              </p>

              {/* Badge */}
              <div className="mb-8">
                <span className="text-xs font-medium text-gray-400 bg-gray-800/50 px-3 py-1 rounded-full tracking-wide">
                  Practice & Build
                </span>
              </div>
              ...
              <Link
                href="/projects"
                className="inline-block w-full text-center bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 hover:from-purple-600 hover:to-purple-700 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/30"
              >
                View Projects
              </Link>
            </div>
            ...
            {[
              {
                icon: "🎥",
                title: "Video Lessons",
                desc: "Learn through comprehensive video tutorials",
              },
              {
                icon: "📝",
                title: "Assignments",
                desc: "Practice with hands-on coding assignments",
              },
              {
                icon: "🚀",
                title: "Real Projects",
                desc: "Build actual websites and applications",
              },
              {
                icon: "📊",
