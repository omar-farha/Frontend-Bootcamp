...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "codes" | "tracking" | "courses" | "projects"
  >("codes");
  ...
  const saveCourse = async () => {
    ...
    setLoading(true);
    try {
      await courseService.update(editingCourse, editingCourseData);
      setCourses(
        courses.map((course) =>
  ...
  const saveCategory = async () => {
    ...
    setLoading(true);
    try {
      await projectService.updateCategory(editingCategory, editingCategoryData);
      setProjects(
        projects.map((category) =>
          category.id === editingCategory ? editingCategoryData : category
        )
      );
      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 max-w-md w-full border border-gray-700">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-[#0fd8d7] mb-2">
              Admin Panel
            </h1>
          ...
          >
            ...
            {!isSupabaseConfigured() && (
              <p className="text-sm mt-2 text-yellow-300">
                Configure Supabase environment variables to enable production
                database features.
              </p>
            )}
          </div>
                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <div className="flex items-center space-x-4 mb-2">
                              <span className="font-mono text-lg font-bold text-[#0fd8d7]">
                                {codeData.code}
                              </span>
                              <span
                            ...
                            <div className="text-sm text-gray-300 grid md:grid-cols-2 gap-2">
                              ...
                              {progress && (
                                <div>
                                  ...
                                  <p>
                                    <strong>Sessions Done:</strong>{" "}
                                    {progress.completed_sessions.length}
                                  </p>
                                  <p>
                                    <strong>Current:</strong>{" "}
                                    {currentInfo?.course?.title ||
                                      "Not started"}
                                  </p>
                                  <p>
                          ...
                          <div className="flex space-x-2">
                            ...
                            <button
                              ...
                              title={
                                codeData.is_active ? "Deactivate" : "Activate"
                              }
                            >
                              {codeData.is_active ? (
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-semibold text-white flex items-center">
                ...
                Student Progress Tracking ({userProgress.length} active
                students)
              </h3>
              <button
                      ...
                      <div className="grid md:grid-cols-3 gap-4 text-sm">
                        <div>
                          ...
                          <p className="text-white font-semibold">
                            {currentInfo?.course?.title || "Not started"}
                          </p>
                        </div>
                        <div>
                          <p className="text-gray-400 mb-1">Current Session</p>
                          <p className="text-white font-semibold">
                            {currentInfo?.session?.title || "Not started"}
                          </p>
                        </div>
                        <div>
                          <p className="text-gray-400 mb-1">Activity</p>
                          <p className="text-white font-semibold">
                            {progress.login_count} logins
                          </p>
                  ...
                  <div className="flex space-x-2">
                    {editingCourse === course.id ? (
                      ...
                      <button
                        ...
                        className="p-2 bg-[#0fd8d7] text-black rounded-lg hover:bg-[#0bc5c4] transition-colors"
                      >
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={
                                editingProjectData?.technologies?.join(", ") ||
                                ""
                              }
                              onChange={(e) =>
                                setEditingProjectData({
                          ...
                          <div>
                            ...
                            <textarea
                              value={
                                editingProjectData?.requirements?.join("\n") ||
                                ""
                              }
                              onChange={(e) =>
                                setEditingProjectData({
                          ...
                          <div>
                            ...
                            <textarea
                              value={editingProjectData?.instructions || ""}
                              onChange={(e) =>
                                setEditingProjectData({
                                  ...editingProjectData,
                          ...
                          <div className="grid md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                type="url"
                                value={editingProjectData?.demo_url || ""}
                                onChange={(e) =>
                                  setEditingProjectData({
                                    ...editingProjectData,
